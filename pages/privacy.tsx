...
export default function Privacy() {
	return (
		<div>
			<Head>
				<title>Tokey Privacy Policy</title>
				<meta name='description' content='Tokey Privacy Policy' />
			...
			<main className={style.container}>
				...
				<div className={style.textContainer}>
					<div className={style.textColumn}>
						...
						<p className={style.italic}>Last updated: March 09, 2022</p>
						<p className={style.p}>
						...
						<h2 className={style.h2}>Interpretation and Definitions</h2>
						<h3 className={style.h3}>Interpretation</h3>
						<p className={style.p}>
						...
						<h3 className={style.h3}>Definitions</h3>
						<p className={style.p}>For the purposes of this Privacy Policy:</p>
						<p className={style.p}>
						...
						<p className={style.p}>
							...
							in this Agreement) refers to Tokey Ltd, 86-90 Paul Street, London,
							EC2A 4NE.
						</p>
						<p className={style.p}>
						...
						<p className={style.p}>
							<strong>Website</strong>&nbsp;refers to Tokey, accessible from
							tokey.app
						</p>
						<p className={style.p}>
						...
						<h2 className={style.h2}>Collecting Your Personal Data</h2>
						<h3 className={style.h3}>Types of Data Collected</h3>
						<h4 className={style.h4}>Personal Data</h4>
						<p className={style.p}>
						...
						<h2 className={style.h2}>Using Your Personal Data</h2>
						<p className={style.p}>
						...
						<ul>
							...
							<li className={style.li}>
								&middot;&nbsp; <strong>For business transfers:</strong>&nbsp;We
						...
						<h2 className={style.h2}>Retention of Your Personal Data</h2>
						<p className={style.p}>
						...
						<h2 className={style.h2}>Transfer of Your Personal Data</h2>
						<p className={style.p}>
						...
						<h2 className={style.h2}>Disclosure of Your Personal Data</h2>
						<h3 className={style.h3}>Business Transactions</h3>
						<p className={style.p}>
						...
						<h3 className={style.h3}>Law enforcement</h3>
						<p className={style.p}>
						...
						<h3 className={style.h3}>Other legal requirements</h3>
						<p className={style.p}>
							The Company may disclose Your Personal Data in the good faith
							belief that such action is necessary to:
						</p>
						<p className={style.p}>
							&middot;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Comply with a legal
							obligation
						</p>
						<p className={style.p}>
							&middot;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Protect and defend the
							rights or property of the Company
						</p>
						<p className={style.p}>
							&middot;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Prevent or investigate
							possible wrongdoing in connection with the Service
						</p>
						<p className={style.p}>
							&middot;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Protect the personal
							safety of Users of the Service or the public
						</p>
						<p className={style.p}>
							&middot;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Protect against legal
							liability
						</p>
						<h2 className={style.h2}>Security of Your Personal Data</h2>
						<p className={style.p}>
						...
						<h2 className={style.h2}>Children&apos;s Privacy</h2>
						<p className={style.p}>
						...
						<h2 className={style.h2}>Links to Other Websites</h2>
						<p className={style.p}>
						...
						<h2 className={style.h2}>Changes to this Privacy Policy</h2>
						<p className={style.p}>
						...
						<p className={style.p}>
							...
							<span className={style.footerLink}>
								<Link href='mailto:info@tokey.app'>info@tokey.app</Link>
							</span>
						</p>
						<p className={style.p}>
